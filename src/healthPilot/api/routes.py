...
from healthPilot.api.endpoints import auth, blood_reports, events, lifestyle, privacy, products, recommendations
...
v1_router.include_router(blood_reports.router, prefix="/blood-reports", tags=["blood-reports"])
